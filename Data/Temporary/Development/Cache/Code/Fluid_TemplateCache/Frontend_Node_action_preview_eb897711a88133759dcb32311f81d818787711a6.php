<?php 
class Frontend_Node_action_preview_eb897711a88133759dcb32311f81d818787711a6 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1['path'] = 'Build/Host.css';
$array3 = array (
...
$arguments11['path'] = 'Build/Host.css';
$array13 = array (
);$arguments11['package'] = $renderingContext->getVariableProvider()->getByPath('compiledResourcePackage', $array13);
// Rendering Boolean node
// Rendering Array
$array14 = array();
$array15 = array (
);$array14['0'] = $renderingContext->getVariableProvider()->getByPath('false', $array15);

$expression16 = function($context) {return TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]);};
$arguments11['localize'] = TYPO3Fluid\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean(
					$expression16(
...
$arguments8['name'] = 'guestFrameApplication';
