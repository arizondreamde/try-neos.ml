...
class ImageController extends ImageController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function createVariantsAction(string $assetSourceIdentifier, string $assetProxyIdentifier, string $overviewAction) : void
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createVariantsAction'])) {
            ...
            try {
                ...
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Media\Browser\Controller\ImageController', 'createVariantsAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();
  ...
  13 => 'assetVariantGenerator',
  14 => 'objectManager',
  15 => 'reflectionService',
  16 => 'mvcPropertyMappingConfigurationService',
  17 => 'viewConfigurationManager',
...
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Media.Browser/Classes/Controller/ImageController.php
#