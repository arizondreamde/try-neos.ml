...
class CacheManager extends CacheManager_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'cacheFactory' => 'Neos\\Cache\\CacheFactoryInterface',
  ...
  'cacheConfigurations' => 'array',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->injectCacheFactory(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Cache\CacheFactoryInterface'));
...
# PathAndFilename: /var/www/neos/Packages/Framework/Neos.Flow/Classes/Cache/CacheManager.php
#