...
class PersistedUsernamePasswordProvider extends PersistedUsernamePasswordProvider_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'precomposedHashProvider' => 'Neos\\Flow\\Security\\Cryptography\\PrecomposedHashProvider',
  'name' => 'string',
  'options' => 'array',
);
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->precomposedHashProvider = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Security\Cryptography\PrecomposedHashProvider');
        $this->Flow_Injected_Properties = array (
  0 => 'accountRepository',
  1 => 'hashService',
  2 => 'securityContext',
  3 => 'persistenceManager',
  4 => 'precomposedHashProvider',
);
    }
}
# PathAndFilename: /var/www/neos/Packages/Framework/Neos.Flow/Classes/Security/Authentication/Provider/PersistedUsernamePasswordProvider.php
#