...
class RuntimeHealthController_Original extends ActionController
{
    /**
...
class RuntimeHealthController extends RuntimeHealthController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Setup\Controller\RuntimeHealthController' === get_class($this)) {
    ...
    public function indexAction() : string
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['indexAction'])) {
            ...
            try {
                ...
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Setup\Controller\RuntimeHealthController', 'indexAction', $methodArguments, $adviceChain);
    ...
    protected function emitViewResolved(\Neos\Flow\Mvc\View\ViewInterface $view)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitViewResolved'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Setup\Controller\RuntimeHealthController', 'emitViewResolved', $methodArguments);
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitViewResolved']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Setup\Controller\RuntimeHealthController', 'emitViewResolved', $methodArguments, NULL, $result);
  ...
  'negotiatedMediaType' => 'string',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->healthchecksConfiguration = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Setup.healthchecks.runtime');
  ...
  10 => 'healthchecksConfiguration',
  11 => 'defaultViewImplementation',
);
    }
}
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Setup/Classes/Controller/RuntimeHealthController.php
#