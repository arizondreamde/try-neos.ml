...
class SessionManager extends SessionManager_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        $isSameClass = get_class($this) === 'Neos\Flow\Session\SessionManager';
        if ($isSameClass) {
  ...
  'logger' => 'Psr\\Log\\LoggerInterface',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Session\SessionManager', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->garbageCollectionProbability = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Flow.session.garbageCollection.probability');
        $this->garbageCollectionMaximumPerRun = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Flow.session.garbageCollection.maximumPerRun');
        $this->inactivityTimeout = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Flow.session.inactivityTimeout');
        $this->Flow_Injected_Properties = array (
  0 => 'metaDataCache',
  1 => 'storageCache',
  2 => 'logger',
  3 => 'garbageCollectionProbability',
  4 => 'garbageCollectionMaximumPerRun',
  5 => 'inactivityTimeout',
);
    }
}
# PathAndFilename: /var/www/neos/Packages/Framework/Neos.Flow/Classes/Session/SessionManager.php
#