...
class SetupCommandController extends SetupCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        parent::__construct();
        if ('Neos\Setup\Command\SetupCommandController' === get_class($this)) {
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->databaseConnectionService = new \Neos\Setup\Infrastructure\Database\DatabaseConnectionService();
...
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Setup/Classes/Command/SetupCommandController.php
#