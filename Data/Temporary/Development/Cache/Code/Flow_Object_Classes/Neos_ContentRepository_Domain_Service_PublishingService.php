...
class PublishingService extends PublishingService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
     ...
     * @api
     */
    public function emitNodeDiscarded(\Neos\ContentRepository\Domain\Model\NodeInterface $node, ?\Neos\ContentRepository\Domain\Model\Workspace $baseWorkspace = NULL)
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodeDiscarded'])) {
            $result = parent::emitNodeDiscarded($node, $baseWorkspace);
...
# PathAndFilename: /var/www/neos/Packages/Application/Neos.ContentRepository/Classes/Domain/Service/PublishingService.php
#