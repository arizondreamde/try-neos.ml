...
class NodeTypesCommandController_Original extends CommandController
{
    #[Flow\Inject]
...
class NodeTypesCommandController extends NodeTypesCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\Command\NodeTypesCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Command\NodeTypesCommandController', $this);
        parent::__construct();
        if ('Neos\ContentRepository\Command\NodeTypesCommandController' === get_class($this)) {
...
# PathAndFilename: /var/www/neos/Packages/Application/Neos.ContentRepository/Classes/Command/NodeTypesCommandController.php
#