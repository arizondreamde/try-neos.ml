...
class DatabaseConnectionService extends DatabaseConnectionService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Setup\Infrastructure\Database\DatabaseConnectionService' === get_class($this)) {
  ...
  'supportedDatabaseDrivers' => 'array<string, string>',
    ...
    {
        $this->supportedDatabaseDrivers = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Setup.supportedDatabaseDrivers');
        $this->Flow_Injected_Properties = array (
  0 => 'supportedDatabaseDrivers',
);
    }
}
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Setup/Classes/Infrastructure/Database/DatabaseConnectionService.php
#