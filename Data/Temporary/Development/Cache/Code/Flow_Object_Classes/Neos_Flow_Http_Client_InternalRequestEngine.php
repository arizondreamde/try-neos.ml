...
class InternalRequestEngine extends InternalRequestEngine_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'contentFactory' => 'Psr\\Http\\Message\\StreamFactoryInterface',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->serverRequestFactory = new \Neos\Http\Factories\ServerRequestFactory(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Psr\Http\Message\UriFactoryInterface'), 'Flow/8.3', 'index.php', '1.1');
...
# PathAndFilename: /var/www/neos/Packages/Framework/Neos.Flow/Classes/Http/Client/InternalRequestEngine.php
#