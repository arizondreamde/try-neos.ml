...
class MergedArrayTree extends MergedArrayTree_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(0, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $tree in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
...
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Fusion/Classes/Core/ObjectTreeParser/MergedArrayTree.php
#