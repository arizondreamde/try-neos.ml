...
class AssetController extends AssetController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function createVariantsAction(string $assetSourceIdentifier, string $assetProxyIdentifier, string $overviewAction) : void
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createVariantsAction'])) {
            parent::createVariantsAction($assetSourceIdentifier, $assetProxyIdentifier, $overviewAction);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['createVariantsAction'] = true;
            try {
                ...
                $adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('createVariantsAction');
                $adviceChain = $adviceChains['Neos\Flow\Aop\Advice\AroundAdvice'];
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Media\Browser\Controller\AssetController', 'createVariantsAction', $methodArguments, $adviceChain);
                $result = $adviceChain->proceed($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

            } catch (\Exception $exception) {
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createVariantsAction']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createVariantsAction']);
        }
...
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Media.Browser/Classes/Controller/AssetController.php
#