...
class RequestHandler extends RequestHandler_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (get_class($this) === 'Neos\Flow\Http\RequestHandler') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Http\HttpRequestHandlerInterface', $this);
...
# PathAndFilename: /var/www/neos/Packages/Framework/Neos.Flow/Classes/Http/RequestHandler.php
#