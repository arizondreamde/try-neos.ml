...
class MediaCommandController extends MediaCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'imageVariantRepository' => 'Neos\\Media\\Domain\\Repository\\ImageVariantRepository',
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\Media\Domain\Repository\ImageVariantRepository', 'Neos\Media\Domain\Repository\ImageVariantRepository', 'imageVariantRepository', 'bdea3cb604173b12ab06650c2bfec79e', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Media\Domain\Repository\ImageVariantRepository'); });
  ...
  6 => 'imageVariantRepository',
  7 => 'assetService',
  8 => 'thumbnailService',
  9 => 'mappingStrategy',
  10 => 'reflectionService',
  11 => 'assetVariantGenerator',
  12 => 'asyncThumbnails',
);
    }
}
# PathAndFilename: /var/www/neos/Packages/Application/Neos.Media/Classes/Command/MediaCommandController.php
#