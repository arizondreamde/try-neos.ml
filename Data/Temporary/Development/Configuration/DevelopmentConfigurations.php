          ...
          array (
            ...
            array (
              ...
              array (
                'matchingExceptionClassNames' => 
                array (
                  0 => 'Neos\\Flow\\Security\\Exception\\InvalidHashException',
                ),
                'options' => 
                array (
                  'logException' => true,
...
',
      ...
      array (
        ...
        array (
          ...
          'styles' => 
          array (
            0 => 'resource://Neos.Neos/Public/Styles/Main.css',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'factoryMethodName' => 'createDriver',
        'arguments' => 
        array (
          1 => 
          array (
            'setting' => 'Neos.Imagine.driver',
          ),
        ),
      ),
    ),
...
',
    ...
    array (
      ...
      array (
        ...
        'help' => 
        array (
          'message' => 'Carousel which can display the following types of content:
* Headline
* Text
* TextWithImage
* Image
...
',
    ...
    array (
      ...
      array (
        ...
        'help' => 
        array (
          'message' => 'List of BlogPosting that allows to specify the blogs and the number of
articles to display.
',
        ),
        'inspector' => 
  ...
  array (
    0 => 
    array (
      'name' => 'Neos.Setup :: Setup',
      'uriPattern' => 'setup/runtime.json',
      'defaults' => 
      array (
        '@package' => 'Neos.Setup',
        '@controller' => 'RuntimeHealth',
        '@action' => 'index',
        '@format' => 'json',
      ),
    ),
    ...
    19 => 
    array (
      'name' => 'Neos.Neos.Ui :: Backend :: Generate UriPathSegment',
      'uriPattern' => 'neos/ui-services/generate-uri-path-segment',
      'defaults' => 
      array (
        '@package' => 'Neos.Neos.Ui',
